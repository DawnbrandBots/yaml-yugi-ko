...
def download_all(db: Literal["yugiohdb", "rushdb"], locale: str) -> str:
    ...
    with Client(http2=True, follow_redirects=True, headers={"Referer": "https://www.db.yugioh-card.com/"}, timeout=Timeout(5, read=15)) as client:
